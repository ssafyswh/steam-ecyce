...
- LLM 클라이언트 호출 관련
  ...
  ![LLM client](/Docs/Images/ai1.png)

- AI 사용 기능 구현 관련
  - 사용자 경험을 바탕으로 성향을 분석하고 추천 게임을 선정하여 제공
  ![get_ai_analysis](/Docs/Images/ai2.png)
  - 전달받은 게임 리뷰들을 바탕으로 그 게임의 정보를 담은 요약문을 작성
  ![get_ai_review_summary](/Docs/Images/ai3.png)
  - 사용자 입력 검색어를 바탕으로 유사도 높은 검색 결과 제공
  ![get_search_recommendation](/Docs/Images/ai4.png)
